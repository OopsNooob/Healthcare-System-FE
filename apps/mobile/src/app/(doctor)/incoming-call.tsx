  ...
  return (
    <SafeAreaView style={tw('flex-1 bg-slate-900 justify-between items-center py-20')}>
      <View style={tw('items-center mt-10')}>
        <Text style={tw('text-slate-400 text-lg mb-2 font-medium')}>Patient Calling...</Text>
        <Text style={tw('text-white text-3xl font-bold mb-8')}>Alex Johnson</Text>
        ...
        <Text style={tw('text-emerald-400 text-base font-medium mt-10')}>Consultation Request</Text>
      </View>
